...
function renderDetail(){
  ...
  el('div','byline',ol,'Illustrative sample of the weekly forecaster note planned for the paid tier');
...
function renderMethod(){
  ...
  add(null,'InletCast is a prototype built by a marine forecaster who runs these inlets — a working demonstration of inlet-scale condition guidance for the Southeast NC coast.');
  ...
  el('p','sig',b,'Built by a marine forecaster who runs these inlets · Hampstead, NC — prototype v'+APP_VERSION+', August 2026.');
}
